...
from .model import BinaryOp, Expression, FunctionIR, Literal, Node, Reference, Unary, UnaryOp, Variable
...
class ExpressionChecker:
    ...
    def check(self, expr: Expression, function: FunctionIR, path: str) -> ScalarType | None:
