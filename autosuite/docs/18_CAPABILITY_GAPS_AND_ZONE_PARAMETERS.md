...
| A10 | Display a text message with the observed OK acknowledgement mode. | F21/F47 and latest APP `dialogtype=showmessage`, `buttonoption=ok`; manual 3.6.17 pp. 66–71. | Message evaluation and suspension/acknowledgement in a controlled execution model. Interactive input, timeout answers and stopping policies require their own probes. |
