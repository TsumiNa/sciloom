...
the [architecture handbook](../website/docs/developer/reference/architecture.md). Future API examples
...
[current implementation](../website/docs/developer/reference/architecture.md). Application/global, GUI
...
flowchart TB
    ...
    subgraph Backend["Validation and serialization"]
        ...
        Specialize --> SIR["sciloom_autosuite / Serialization IR"]
