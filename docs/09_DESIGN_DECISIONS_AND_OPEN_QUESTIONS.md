...
24. Semantic format v4 uses explicit occurrence IDs and owned variable references, including typed list operations; XML IDs are assigned by the backend. JSON import/export preserves IDs and semantic order. Earlier versions are rejected.
