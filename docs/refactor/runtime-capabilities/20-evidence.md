...
| A03 Zone | F24 dynamic Stir; F30/F34/F48, primary APP layout; [value/layout mapping](../../../autosuite/docs/29_ZONE_VALUES_AND_LAYOUT.md) | 3.6.19 pp. 73–74, 3.8.5 p. 113, 3.9.2–3, 3.11.5 | Stage 13 values, fixed directory and read-only APP extraction implemented; dynamic actions pending stage 16 | Native union order, name/label behavior and call copies pending. WellName/nonempty literal compilation rejected. Candidate checks and fail-before-action remain stage 16 |
