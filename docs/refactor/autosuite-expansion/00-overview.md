...
**R0–R5 implementation stages are merged; R6.1 is implemented in this PR.**
R2 native unlocks, R6.2–R6.3 and R7 remain pending; native verification is recorded separately.
...
| R6 | Location arguments and simple volumetric transfer | [Overview](r6-volumetric-transfer/00-overview.md) | R6.1 implemented, review/merge pending; R6.2–R6.3 pending | Exact transfer profile pending |
