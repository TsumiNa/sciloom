...
| R3 | Text and yes/no operator results | [Overview](r3-operator-dialogs/00-overview.md) | R3.1 merged #107; R3.2 implemented/gated, review/merge pending | Result/cancel/timeout pending |
