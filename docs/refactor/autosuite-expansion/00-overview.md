...
| R4 | Typed command effects and multi-property device state | [Overview](r4-device-contracts/00-overview.md) | R4.1 implemented, review/merge pending; R4.2 pending | No new platform claim |
