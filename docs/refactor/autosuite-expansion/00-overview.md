...
**R0, R1 and R2.1 are merged; R3.1 dialog semantics are implemented in this PR.**
R2 native unlocks and R3.2–R7 remain planned; native verification remains pending.
...
| R3 | Text and yes/no operator results | [Overview](r3-operator-dialogs/00-overview.md) | R3.1 implemented, review/merge pending; R3.2 pending | Result/cancel/timeout pending |
