...
EXAMPLES = (
    ...
    "stir_selected_location.py",
    "label_sample_log.py",
    "aspiration_chunk.py",
    "developer/runtime_workflows_ir.py",
    "developer/runtime_workflows_ir.reagent.json",
    "developer/runtime_workflows_ir.shaker.json",
    "developer/runtime_workflows_ir.labels.json",
    "developer/aspiration_chunk_ir.py",
    "developer/aspiration_chunk_ir.json",
    ...
    "developer/barcode_ir.py",
    "developer/barcode_ir.json",
    ...
    "temperature_values.py",
    "developer/temperature_ir.py",
    "developer/temperature_ir.json",
    "warm_sample.py",
    "developer/warm_sample_ir.py",
    "developer/warm_sample_ir.json",
    "transfer_sample.py",
    "developer/transfer_sample_ir.py",
    "developer/transfer_sample_ir.json",
    "mixed_equipment.py",
    "developer/mixed_equipment_ir.py",
    "developer/mixed_equipment_ir.json",
    "developer/deployment_review.py",
    "developer/deployment_review.asfp",
    "developer/deployment_review.deployment.json",
    "transfer_settings.py",
    "developer/transfer_values_ir.py",
    "developer/transfer_values_ir.json",
    "developer/location_command_ir.py",
    "developer/location_command_ir.json",
