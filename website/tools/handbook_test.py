...
@pytest.mark.parametrize(
    ...
    (
        ...
        *((f"user-guide/tutorial/{page}", source) for page, source in USER_LESSONS),
        ...
        ("examples/stir-selected-location", "stir_selected_location"),
        ("examples/label-sample-log", "label_sample_log"),
        ("examples/aspiration-chunk", "aspiration_chunk"),
        ("examples/runtime-workflows-ir", "developer/runtime_workflows_ir"),
        ("examples/aspiration-chunk-ir", "developer/aspiration_chunk_ir"),
