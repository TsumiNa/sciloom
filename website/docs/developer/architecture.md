...
time. The IR expresses every property and operation through the same generic
nodes with semantic ids, and the compiler decides only whether the current IR
compiles for the selected target; neither knows or special-cases any author
subclass.
