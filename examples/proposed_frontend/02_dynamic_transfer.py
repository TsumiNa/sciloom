...
from autosuite import Function, Input, Local, Array, Zone, Volume, Integer, Boolean, runtime
from autosuite.units import mL
...
class DynamicTransfer(Function):
    ...
    remaining: Local[Volume] = 0 * mL
    done: Local[Boolean] = False
