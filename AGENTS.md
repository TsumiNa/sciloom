...
7. `.compile()` belongs on the AutoSuite model instance (typically inherited from a common base) and should return a compile result without mutating the semantic meaning of the source instance.
